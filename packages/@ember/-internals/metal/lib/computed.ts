...
export class ComputedProperty<Get, Set = Get> extends ComputedDescriptor {
  ...
  volatileSet(obj: object, keyName: string, value: Set): any {
    return this._setter!.call(obj, keyName, value, undefined);
  }
...
class ComputedDecoratorImpl<Get, Set = Get> extends Function {
  ...
  */
  volatile(this: Decorator) {
    ...
    (descriptorForDecorator(this) as ComputedProperty<Get, Set>)._volatile = true;
    return this;
  }
  ...
  */
  property(this: Decorator, ...keys: string[]) {
    ...
    (descriptorForDecorator(this) as ComputedProperty<Get, Set>)._property(...keys);
    return this;
  }
